...
figure;
subplot(3,2,1);
plot(Signal(3*Period:100:4*Period-Delay),Signal(3*Period+Delay:100:4*Period));
title('Signal');
subplot(3,2,2);
plot(TmpFile1.Output(3*Period:100:4*Period-Delay),TmpFile1.Output(1,3*Period+Delay:100:4*Period));
title(Str1);
subplot(3,2,3);
plot(TmpFile2.Output(3*Period:100:4*Period-Delay),TmpFile2.Output(1,3*Period+Delay:100:4*Period));
title(Str2);
subplot(3,2,4);
plot(TmpFile3.Output(3*Period:100:4*Period-Delay),TmpFile3.Output(1,3*Period+Delay:100:4*Period));
title(Str3);
subplot(3,2,5);
plot(TmpFile4.Output(3*Period:100:4*Period-Delay),TmpFile4.Output(1,3*Period+Delay:100:4*Period));
title(Str4);
subplot(3,2,6);
plot(TmpFile5.Output(3*Period:100:4*Period-Delay),TmpFile5.Output(1,3*Period+Delay:100:4*Period));
title(Str5);
...
% title('Signal');
% subplot(3,2,2);
% plot(TmpFile1.Output(3*Period:100:4*Period-Delay),mean(TmpFile1.Output(:,3*Period+Delay:100:4*Period)));
% title(Str1);
% subplot(3,2,3);
% plot(TmpFile2.Output(3*Period:100:4*Period-Delay),mean(TmpFile2.Output(:,3*Period+Delay:100:4*Period)));
% title(Str2);
% subplot(3,2,4);
% plot(TmpFile3.Output(3*Period:100:4*Period-Delay),mean(TmpFile3.Output(:,3*Period+Delay:100:4*Period)));
% title(Str3);
% subplot(3,2,5);
% plot(TmpFile4.Output(3*Period:100:4*Period-Delay),mean(TmpFile4.Output(:,3*Period+Delay:100:4*Period)));
% title(Str4);
% subplot(3,2,6);
% plot(TmpFile5.Output(3*Period:100:4*Period-Delay),mean(TmpFile5.Output(:,3*Period+Delay:100:4*Period)));
% title(Str5);
...
% figure;
% subplot(3,2,1);
% plot(Signal(3*Period:100:4*Period),Signal(4*Period:100:5*Period));
% title('Signal');
% subplot(3,2,2);
% plot(TmpFile1.Output(3*Period:100:4*Period),TmpFile1.Output(1,4*Period:100:5*Period));
% title(Str1);
% subplot(3,2,3);
% plot(TmpFile2.Output(3*Period:100:4*Period),TmpFile2.Output(1,4*Period:100:5*Period));
% title(Str2);
% subplot(3,2,4);
% plot(TmpFile3.Output(3*Period:100:4*Period),TmpFile3.Output(1,4*Period:100:5*Period));
% title(Str3);
% subplot(3,2,5);
% plot(TmpFile4.Output(3*Period:100:4*Period),TmpFile4.Output(1,4*Period:100:5*Period));
% title(Str4);
% subplot(3,2,6);
% plot(TmpFile5.Output(3*Period:100:4*Period),TmpFile5.Output(1,4*Period:100:5*Period));
% title(Str5);